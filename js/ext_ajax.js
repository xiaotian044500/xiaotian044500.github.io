 ...
 *
 *  min ajax lib, modify for requirejs
 *  note: file bottom give a real example
 *  work for: maybe only themes/ecmoban_dsc/js/ *.js
 * ------------------------------------------------------------------
 */
...
define(function() {
    ...
    return minajax_class
})
/*
EXAMPLE:
---
minAjax({
    url:"http://123.206.85.61/admin/ext/isexist_good_by_sn.php",//request URL
